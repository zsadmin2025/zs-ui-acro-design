<template>
    ...
    <a-list-item>
      <a-list-item-meta>
        ...
        <template #description>
          ...
          <div class="operation">
            <a-link @click="handleEditPassword">
  ...
  <UserResetPassword
    ...
    @update:visible="handleResetPasswordVisible"
  />
</template>
...
<script lang="ts" setup>
  ...
  // 控制弹窗显示隐藏的方法
  const handleResetPasswordVisible = (visible: boolean) => {
    resetPasswordVisible.value = visible;
  };
</script>
