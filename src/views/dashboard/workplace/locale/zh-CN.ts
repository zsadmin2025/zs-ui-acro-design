export default {
  ...
  'workplace.contentManagement': '利冲预检',
  'workplace.contentStatistical': '立项申请',
  'workplace.advanced': '案件登记',
  'workplace.onlinePromotion': '案件跟进',
  'workplace.contentPutIn': '用章申请',
  'workplace.announcement': '公告',
  'workplace.recently.visited': '最近访问',
  'workplace.record.nodata': '暂无数据',
  'workplace.quick.operation': '我的常用',
  'workplace.recent.work': '近期工作',
