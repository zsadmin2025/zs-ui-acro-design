<template>
  ...
  >
    <template #title>
      <h4>
        {{ !form.categoryId ? '新增商品档案' : '修改商品档案' }}
      </h4>
    </template>
    <a-form ref="formRef" :model="form" :rules="rules" auto-label-width>
      <a-form-item label="类别名称" field="categoryName">
        <a-input
...
<script lang="ts" setup>
  ...
  import { useCategoryAddOrEditStore } from '@/store/modules/business/goods/category/categoryAddOrEditStore';
